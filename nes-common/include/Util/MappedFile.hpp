// MappedFile.hpp
// Minimal cross-platform-ish memory-mapped read utility (POSIX-only fallback).
#pragma once
...
#if defined(_WIN32)
// Stub for Windows; implement as needed in future phases.
namespace NES::Util {
class MappedFile {
  public:
    explicit MappedFile(const std::string& /*path*/) {
        throw std::runtime_error("MappedFile is not implemented on Windows in this phase");
    }
    ~MappedFile() = default;
