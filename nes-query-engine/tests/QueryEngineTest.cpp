...
TEST_F(QueryEngineTest, singleQueryWithShutdown)
{
    ...
    test.expectQueryStatusEvents(queryId, {QueryState::Compiling, QueryState::Started, QueryState::Running});
...
TEST_F(QueryEngineTest, singleQueryWithSystemShutdown)
{
    ...
    test.expectQueryStatusEvents(id, {QueryState::Compiling, QueryState::Started, QueryState::Running});
...
TEST_F(QueryEngineTest, singleQueryWithExternalStop)
{
    ...
    test.expectQueryStatusEvents(QueryId(1), {QueryState::Compiling, QueryState::Started, QueryState::Running, QueryState::Stopped});
...
TEST_F(QueryEngineTest, singleQueryWithSourceFailure)
{
    ...
    auto ctrl = test.sourceControls[source];
    auto sinkCtrl = test.sinkControls[sink];
    test.expectQueryStatusEvents(QueryId(1), {QueryState::Compiling, QueryState::Started, QueryState::Running, QueryState::Failed});
...
TEST_F(QueryEngineTest, singleQueryWithTwoSourcesShutdown)
{
    ...
    auto sinkCtrl = test.sinkControls[sink];
    test.expectQueryStatusEvents(QueryId(1), {QueryState::Compiling, QueryState::Started, QueryState::Running});
...
TEST_F(QueryEngineTest, failureDuringPipelineStop)
{
    ...
    test.expectQueryStatusEvents(id, {QueryState::Compiling, QueryState::Started, QueryState::Running, QueryState::Failed});
...
TEST_F(QueryEngineTest, failureDuringPipelineStartWithMultiplePipelines)
{
    ...
    test.expectQueryStatusEvents(id, {QueryState::Compiling, QueryState::Started, QueryState::Failed});
...
TEST_F(QueryEngineTest, failureDuringPipelineCompilation)
{
    TestingHarness test;
    auto builder = test.buildNewQuery();
    auto source = builder.addSource();
    ...
    auto query = test.addNewQuery(std::move(builder));
    auto id = query->queryId;
    test.pipelineControls[failingPipeline]->failOnCompile = true;

    test.expectQueryStatusEvents(id, {QueryState::Compiling, QueryState::Failed});
...
TEST_F(QueryEngineTest, ManyQueriesWithTwoSources)
{
    ...
    for (const auto& [index, _] : queryPlans | views::enumerate)
    {
        ...
        test.expectQueryStatusEvents(
            QueryId(1 + index), {QueryState::Compiling, QueryState::Started, QueryState::Running, QueryState::Stopped});
    }
...
TEST_F(QueryEngineTest, ManyQueriesWithTwoSourcesOneSourceFails)
{
    ...
    test.expectQueryStatusEvents(QueryId(2), {QueryState::Compiling, QueryState::Started, QueryState::Running, QueryState::Stopped});
...
TEST_F(QueryEngineTest, singleQueryWithSlowlyFailingSourceDuringQueryPlanTermination)
{
    ...
    test.expectQueryStatusEvents(query->queryId, {QueryState::Compiling, QueryState::Started, QueryState::Running, QueryState::Stopped});
...
TEST_F(QueryEngineTest, ManyQueriesWithTwoSourcesAndPipelineFailures)
{
    ...
    for (size_t index = 1; const auto& query : queryPlans | std::ranges::views::drop(1))
    {
        ...
        sinkCtrls.push_back(test.sinkControls[sinks[index]]);
        test.expectQueryStatusEvents(
            QueryId(1 + index), {QueryState::Compiling, QueryState::Started, QueryState::Running, QueryState::Failed});
        index++;
    }
