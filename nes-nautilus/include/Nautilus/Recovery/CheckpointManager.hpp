...
// Phase 4 Week 1: checkpoint, checkpointAsync, recover
#pragma once
...
// A small, self-contained serializer that writes bytes with an atomic rename.
// This is intentionally minimal for Week 1 to avoid external dependencies.
class CheckpointManager {
  public:
    ...
    // Serialize PipelineState using a simple, stable binary framing for Week 1.
    // Note: This is a placeholder until reflect-cpp/Cap'n Proto serialization is wired.
